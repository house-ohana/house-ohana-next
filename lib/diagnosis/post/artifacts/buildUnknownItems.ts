...
const CANDIDATES: UnknownCandidateDef[] = [
  ...
  },
  {
    ...
    priority: 80,
    text: "契約内容について、ご本人が説明をどの程度理解し、考えを伝えられているかを確認しましょう。",
