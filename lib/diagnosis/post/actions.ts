...
export function buildActionCandidates(answers: PostValidAnswers, v: PostVariables): ActionCandidate[] {
  const isDischarged = answers.c1 === "discharged";

  return [
    {
      id: "p1_hospital",
      when: v.isImmediateDeadline && (v.supportUnclear || v.residenceUnclear) && answers.c1 === "hospitalized",
      primaryPriority: 1,
      dedupeGroup: "discharge_support",
      secondaryGroupOrder: SECONDARY_GROUP_ORDER.discharge_support,
      headline:
        "今日、病院の退院支援担当者に確認しましょう。「退院予定日」「退院直後に必要な支援」「退院までに家族が決める必要があること」の3点を確認します。",
      deadline: "今日",
      contact: "病院の退院支援担当者",
    ...
    },
    {
      ...
      secondaryGroupOrder: SECONDARY_GROUP_ORDER.discharge_support,
      headline:
        "今日、ご本人の住所地を担当する地域包括支援センターへ相談しましょう。「退院後の住まいや支援がまだ整っていない」と伝え、最初に確認すべき窓口を聞きます。",
      deadline: "今日",
      contact: "地域包括支援センター",
    ...
    {
      id: "p2_hospital",
      when: v.isImmediateDeadline && v.supportPartlyUnclear && answers.c1 === "hospitalized",
      primaryPriority: 2,
      dedupeGroup: "discharge_support",
      secondaryGroupOrder: SECONDARY_GROUP_ORDER.discharge_support,
      headline:
        "今日、退院後の支援で未決定の項目を確認しましょう。病院の退院支援担当者やケアマネジャーに、「決まっていること」と「まだ決まっていないこと」を分けて確認します。",
      deadline: "今日",
    ...
    },
    {
      ...
      secondaryGroupOrder: SECONDARY_GROUP_ORDER.discharge_support,
      headline:
        "今日、退院後の支援で未決定の項目を確認しましょう。現在相談している担当者、または地域包括支援センターに、「決まっていること」と「まだ決まっていないこと」を分けて確認します。",
      deadline: "今日",
    ...
    },
    {
      ...
      secondaryGroupOrder: SECONDARY_GROUP_ORDER.discharge_support,
      headline:
        "3日以内に、退院後の住まいと支援について担当者と確認しておきましょう。完全な結論を出すのではなく、「退院直後はどこで、誰の支援を受けるか」を仮置きします。",
      deadline: "3日以内",
      contact: "退院後の担当者",
    ...
    },
    {
      ...
      when: v.activeSupportGap && answers.c1 === "hospitalized",
      primaryPriority: 4,
      dedupeGroup: "discharge_support",
      secondaryGroupOrder: SECONDARY_GROUP_ORDER.discharge_support,
      headline:
        "今日、病院の退院支援担当者に、退院の見込み時期と必要な支援を確認しましょう。退院日がまだ決まっていなくても、「退院の見込み」「退院までに家族が決めること」「退院直後に必要な支援」の3点を先に確認しておきます。",
      deadline: "今日",
      contact: "病院の退院支援担当者",
    ...
    },
    {
      ...
      when: v.activeSupportGap && answers.c1 === "facility_search",
      primaryPriority: 4,
      dedupeGroup: "discharge_support",
      secondaryGroupOrder: SECONDARY_GROUP_ORDER.discharge_support,
      headline:
        "3日以内に、現在相談している担当者または地域包括支援センターへ確認しましょう。「住み替えの希望時期」「候補を絞る前に確認する支援」「当面の費用」の3点を整理します。",
      deadline: "3日以内",
      contact: "現在相談している担当者、または地域包括支援センター",
    ...
    },
    {
      ...
      headline: `${v.moneyCheckDeadline}、退院・入居後3か月のお金を1枚に並べておきましょう。年金、預貯金、加入済み保険の給付、施設・住居費、医療・介護費、実家の維持費、家族の持ち出しを分けます。住まいと支援の確認を止めず、並行して行います。`,
    ...
    },
    {
      ...
      headline:
        "3日以内に、ご本人が続けたい暮らしを一つ確認しておきましょう。「どこに住みたいか」だけでなく、「今までの生活で何を続けたいか」を聞きます。",
      deadline: "3日以内",
      contact: "ご本人",
    ...
    },
    {
      ...
      secondaryGroupOrder: SECONDARY_GROUP_ORDER.wishes,
      headline:
        "3日以内に、ご本人のこれまでの希望を知る人へ確認しておきましょう。家族や支援者に、「本人が以前どのような暮らしを望んでいたか」を確認します。これだけで本人の意思を決めつけないようにしましょう。",
      deadline: "3日以内",
    ...
    },
    {
      ...
      headline:
        "実家を売る・貸す契約を進める前に、法律の専門家へ確認しましょう。ご本人の現在の様子と、予定している契約を伝え、誰がどのような手続を行えるかを確認します。",
      deadline: "契約前",
      contact: "司法書士または弁護士",
    ...
    },
    {
      ...
      secondaryGroupOrder: SECONDARY_GROUP_ORDER.contract_before_home_action,
      headline:
        "実家について契約を進める前に、ご本人の現在の理解と希望を確認しましょう。確認が難しい場合は、契約を先に進めず、司法書士や弁護士などへ相談します。",
      deadline: "契約前",
      contact: "司法書士または弁護士",
    ...
    },
    {
      ...
      secondaryGroupOrder: SECONDARY_GROUP_ORDER.money_3_months,
      headline:
        "1週間以内に、これから3か月のお金を1枚に並べておきましょう。年金、預貯金、保険の給付、施設・住居費、医療・介護費、実家の維持費、家族の持ち出しを分けて記録します。",
      deadline: "1週間以内",
      contact: "家族内",
    ...
    },
    {
      ...
      headline: "1週間以内に、実家を誰が管理するか決めておきましょう。鍵、郵便物、換気、通水、庭、火災保険、緊急連絡先の担当を確認します。",
      deadline: "1週間以内",
      contact: "家族内",
      title: "実家の管理担当（鍵・郵便物・換気・通水・庭・火災保険・緊急連絡先）を決める",
    },
    // p12系: 他の優先条件に該当しない、情報が少ない状態（低情報状態）向けの既定の行動。
    // v3.1修正版指示書 第9-3節にもとづき、q1（入院中／退院済み／施設探し中）で窓口を分ける。
    // q1はfutureを除く3値のいずれかを必ず取るため、このグループは常にどれか1件がwhen=trueになる。
    {
      id: "p12_low_info_hospitalized",
      when: answers.c1 === "hospitalized",
      primaryPriority: 12,
      dedupeGroup: "low_info_default",
      // 情報が少ない状態向けの汎用的な内容のため、次に確認することの一覧には出さない
      secondaryGroupOrder: null,
      headline:
        "3日以内に、病院の退院支援担当者へ確認しておきましょう。退院までの見通しと、今のうちに家族が準備しておくことを聞いておくと安心です。",
      deadline: "3日以内",
      contact: "病院の退院支援担当者",
      title: "退院までの見通しと家族が準備しておくことを確認する",
    },
    {
      id: "p12_low_info_discharged",
      when: isDischarged,
      primaryPriority: 12,
      dedupeGroup: "low_info_default",
      secondaryGroupOrder: null,
      headline:
        "3日以内に、地域包括支援センターまたは現在の担当者へ、今の状況を伝えておきましょう。まだ決まっていないことがあれば、あわせて伝えておくと相談がスムーズです。",
      deadline: "3日以内",
      contact: "地域包括支援センターまたは現在の担当者",
      title: "今の状況と、まだ決まっていないことを伝える",
    },
    {
      id: "p12_low_info_facility_search",
      when: answers.c1 === "facility_search",
      primaryPriority: 12,
      dedupeGroup: "low_info_default",
      secondaryGroupOrder: null,
      headline:
        "3日以内に、現在の相談先または地域包括支援センターへ、希望時期・必要な支援・予算の条件を伝えておきましょう。",
      deadline: "3日以内",
      contact: "現在の相談先または地域包括支援センター",
      title: "希望時期・必要な支援・予算の条件を伝える",
    },
    {
      id: "p_few_supporters",
      // 身寄りや頼れる人が少ない場合は、低情報状態向けの既定の行動（p12系, q1が真であれば常に真）より
      ...
      headline:
        "3日以内に、ご本人の住所地を担当する地域包括支援センターへ「身寄りや頼れる人が少ない」と伝えましょう。介護、生活支援、権利擁護など、頼れる相談先を一緒に整理してもらえます。",
      deadline: "3日以内",
      contact: "地域包括支援センター",
    ...
    },
    {
      ...
      dedupeGroup: "family_support_load",
      secondaryGroupOrder: SECONDARY_GROUP_ORDER.family_support_load,
      headline: "3日以内に、家族内または地域包括支援センターへ連絡、通院、費用確認、実家管理のうち、一人で抱えている項目を分けておきましょう。",
      deadline: "3日以内",
...
export type PostFirstAction = { id: string; headline: string };
...
export function buildFirstAndNextActions(
  ...
  return { firstAction: { id: primary.id, headline: primary.headline }, nextActions };
}
